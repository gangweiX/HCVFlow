...
from hcvflow.hcvflow import build_model
...
def main(args):
    ...
    while total_steps < args.num_steps:
        ...
        for i, sample in enumerate(train_loader):
            ...
            flow_init, flow_preds = model(img1, img2, iters=args.train_iters)

            loss, metrics = criterion(flow_init, flow_preds, flow_gt, valid,
                                      gamma=args.gamma,
